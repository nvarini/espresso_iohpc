...
SUBROUTINE wstat_memory_report()
  ...
  USE wvfct,          ONLY : npwx, nbnd, nbndx, npw
  ...
  USE westcom,        ONLY : nbnd_occ,n_pdep_basis
  ...
  WRITE( stdout, '(5x,"[MEM] h_diag                  ",f10.2," Mb", 5x,"(",i7,",",i5,")")') &
  ...
  !
  WRITE(stdout,'(5x,"[MEM] ----------------------------------------------------------")')
  WRITE( stdout, '(5x,"[MEM] TOT                     ",f10.2," Mb", 5x)') MAX(mem_tot1,mem_tot2)
  WRITE(stdout,'(5x,"[MEM] ----------------------------------------------------------")')
  !
END SUBROUTINE
