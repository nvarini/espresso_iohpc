  ...
  CONTAINS
    ...
    SUBROUTINE pdep_db_write( )
      ...
      USE westcom,              ONLY : wstat_calculation,n_pdep_times,n_pdep_eigen,n_pdep_maxiter,n_dfpt_maxiter, &
                                     ...
                                     & tr2_dfpt,l_deflate,l_kinetic_only,ev,dvg,west_prefix,wstat_dirname
    ...
    SUBROUTINE pdep_db_read( nglob_to_be_read )
      !------------------------------------------------------------------------
      !
      USE westcom,        ONLY : n_pdep_eigen,ev,dvg,west_prefix
      USE io_global,      ONLY : stdout 
      USE mp,             ONLY : mp_bcast,mp_barrier
      ...
      INTEGER :: dime, iun, global_j, local_j,npw_g
